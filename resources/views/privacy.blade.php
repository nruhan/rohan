...
<div id="wrapper">
  <div class="menuzone">
    <div class="topMenu">
      <ul>
        <li class="first"><a href="{{asset('home')}}">Home</a></li>
        <li><a href="{{asset('about')}}">About Us</a></li>
        <li><a href="{{asset('project')}}">Projects</a></li>
        <li><a href="{{asset('contact')}}">Contact_us</a></li>
        <li><a class="current" href="{{asset('privacy')}}">Privacy</a></li>
      </ul>
    </div>
    <div class="clear"></div>
  </div>
